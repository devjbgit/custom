...
od = load_detector('./saved_outlier_models/model')
...
# print('???  ',labels[test_bad_image_predict['data']['is_outlier'][0]])
...
plot_feature_outlier_image(od_preds,
                           X,
                           X_recon=X_recon,
                           instance_ids=[1, 7, 12, 18, 19],  # pass a list with indices of instances to display
